...
function createtime1() {
  var grt = new Date("12/06/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by codeGao🍟 %c 你正在访问codeGao🍟の小家",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("12/6/2022 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/梦想交易所-贩卖梦想-6adea8?style=social&logo=CodeIgniter' title='我把我滴梦想就卖了三两三~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 蓝色空间号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/梦想交易所-打烊休息啦-6adea8?style=social&logo=CodeIgniter' title='梦想总是遥不可及.'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 蓝色空间号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/images/haimianbb_yasuo.png);
    --darkmode-bg:url(/images/haimianbb_yasuo.png);
    --mobileday-bg: url(/images/haimianbb_yasuo.png);
    --mobilenight-bg: url(/images/haimianbb_yasuo.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
